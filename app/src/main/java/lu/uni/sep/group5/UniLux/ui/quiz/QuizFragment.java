...
public class QuizFragment extends Fragment implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // Button buttonStartQuiz = get getView().findViewById(R.id.button_start_quiz);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button upButton =  (Button) view.findViewById(R.id.button_start_quiz);
    ...
    private void loadHighscore() {
        ...
        switch(Activity_quiz.language) {
            case "fr":
                textViewHighscore.setText("Record: " + highscore);break;
            default:
